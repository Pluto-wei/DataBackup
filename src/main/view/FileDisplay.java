...
public class FileDisplay extends JList {
    ...
    private JMenuItem tarItem; // 打包菜单项
    private JMenuItem untarItem; // 解包菜单项
    ...
    public FileDisplay() {
        ...
        tarItem = new JMenuItem();
        untarItem = new JMenuItem();
        ...
        setMenuItemStyle(tarItem, "tar");
        filePopupMenu.add(tarItem);

        setMenuItemStyle(untarItem, "untar");
        filePopupMenu.add(untarItem);
    ...
    public void addTarListener(ActionListener tar){
        tarItem.addActionListener(tar);
    }
    public void addUnTarListener(ActionListener untar){
        untarItem.addActionListener(untar);
    }
